...
- [ ] **Backup data**  
  ...
  - The operator defaults to `cashubtc/mintd:0.16`; for PostgreSQL mints, take a fresh verified backup immediately before rollout because CDK performs DB migrations across minor versions.
