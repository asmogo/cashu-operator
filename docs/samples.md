...
| [`mint_v1alpha1_cashumint_arkade_processor.yaml`](https://github.com/asmogo/cashu-operator/blob/main/config/samples/mint_v1alpha1_cashumint_arkade_processor.yaml) | Arkade Lightning sidecar | Arkade processor image, HTTP/2 port 8080, PostgreSQL connection wiring |
